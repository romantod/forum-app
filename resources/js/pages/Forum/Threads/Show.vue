...
const submitReply = () => form.post('/forum/' + props.thread.category.slug + '/' + props.thread.slug + '/replies', {
        ...
        <div class="max-w-3xl mx-auto p-6">
            ...
            <div class="space-y-6 select-none">
                ...
                <div>
                    ...
                    <textarea rows="4" placeholder="Ваш ответ..." v-model="form.body" class="w-full p-3 
                    rounded bg-gray-700 text-white placeholder-gray-400 border border-gray-600"></textarea>
                    <p v-if="form.errors.body" class="text-red-400 text-sm">{{ form.errors.body }}</p>
                    <button @click="submitReply" :disabled="form.processing" class="mt-2 bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded">
                        Отправить
                    </button>
                </div>
