...
const props = defineProps({ category: Object, thread: Object });
const form = useForm({ title: props.thread.title, body: props.thread.body });
const submit = () => form.put('/forum/' + props.category.slug + '/' + props.thread.slug);

</script>

<template>
    <Head title="Редактировать тему" />
    ...
    <div class="max-w-3xl p-6">
        ...
        <div class="max-w-3xl mx-auto p-6 space-y-6">
            <h1 class="text-xl font-bold text-white mb-6">Редактировать тему:&nbsp;
